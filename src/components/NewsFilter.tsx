...
const NewsFilter = ({ availableTags, selectedTags, onTagsChange, onClearFilters }: NewsFilterProps) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm border-white/10 rounded-lg p-6 mb-8">
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center">
        <div className="flex-1">
          <label className="text-white/70 text-sm mb-2 block">Filter by Topic:</label>
            ...
            {selectedTags.map((tag) => (
              ...
              >
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-auto p-0 ml-1 text-blue-400 hover:text-blue-300"
